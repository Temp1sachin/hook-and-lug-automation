/* ─────────────────────────────────────────────────────────────
   Hook-Lug Alignment Detection System  •  main.js
   ───────────────────────────────────────────────────────────── */
...
function renderStatusList(alignments) {
  ...
  els.statusList.innerHTML = alignments.map((al, i) => {
    ...
    const dx        = al.dx   != null ? (al.dx >= 0 ? "+" : "") + al.dx   + " px" : "—";
    const dy        = al.dy   != null ? (al.dy >= 0 ? "+" : "") + al.dy   + " px" : "—";
    const dist      = al.distance != null ? al.distance + " px" : "—";
